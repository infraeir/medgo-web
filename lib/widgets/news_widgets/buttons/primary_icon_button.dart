...
class PrimaryIconButtonMedGo extends StatefulWidget {
  ...
  @override
  State<PrimaryIconButtonMedGo> createState() => _PrimaryIconButtonMedGoState();
}

class _PrimaryIconButtonMedGoState extends State<PrimaryIconButtonMedGo> {
