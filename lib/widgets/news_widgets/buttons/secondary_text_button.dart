...
class SecondaryTextButtonMedGo extends StatefulWidget {
  final VoidCallback onTap;
  final String title;
  final bool isDisabled;

  const SecondaryTextButtonMedGo({
    super.key,
    required this.onTap,
    required this.title,
  ...
  @override
  State<SecondaryTextButtonMedGo> createState() =>
      _SecondaryTextButtonMedGoState();
}

class _SecondaryTextButtonMedGoState extends State<SecondaryTextButtonMedGo> {
