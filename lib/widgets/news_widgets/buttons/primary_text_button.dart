...
class PrimaryTextButtonMedGo extends StatefulWidget {
  final VoidCallback onTap;
  final String title;
  final bool isDisabled;

  const PrimaryTextButtonMedGo({
    super.key,
    required this.onTap,
    required this.title,
  ...
  @override
  State<PrimaryTextButtonMedGo> createState() => _PrimaryTextButtonMedGoState();
}

class _PrimaryTextButtonMedGoState extends State<PrimaryTextButtonMedGo> {
  ...
  static const double baseHorizontalPadding = 26.0;
  ...
  Widget build(BuildContext context) {
    ...
    // Cores do background
    const Color normalBgColor = AppTheme.primaryBackground;
