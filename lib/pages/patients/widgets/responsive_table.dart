...
class ResponsiveTable extends StatelessWidget {
  ...
  final List<List<Widget>> bodyCells;
  ...
  const ResponsiveTable({
    ...
    this.scrollController, // Adicione aqui
  }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    assert(() {
      if (headerCells.length != columnFlex.length) {
        throw FlutterError(
            'headerCells e columnFlex devem ter o mesmo comprimento');
      }
      for (final row in bodyCells) {
        if (row.length != headerCells.length) {
          throw FlutterError(
              'Cada linha de bodyCells deve ter o mesmo comprimento que headerCells');
        }
      }
      return true;
    }());
                              ...
                              child: Padding(
                                ...
                                child: Row(
                                  children: List.generate(
                                      bodyCells[rowIndex].length, (cellIndex) {
                                    return Expanded(
                                      flex: columnFlex[cellIndex],
                                      child: bodyCells[rowIndex][cellIndex],
                                    );
                                  }),
                                ),
                              ),
                      ...
                      return Card(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children:
                                List.generate(headerCells.length, (cellIndex) {
                              return Padding(
